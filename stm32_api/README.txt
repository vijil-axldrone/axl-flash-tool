...
# 10 examples are developed and compatible with Visual Studio and Qt creator IDEs:
	...
	-	1 example with USB DFU for MPU based devices [Flashing services]
        -       1 example with USB DFU for MPU devices for secure provisioning SSP.
